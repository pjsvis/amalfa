...
- [01-harvest.ts](src/pipeline/lexicon/01-harvest.ts)
...
- [06-ingest.ts](src/pipeline/lexicon/06-ingest.ts)
...
- [pipeline.dot](src/pipeline/lexicon/pipeline.dot)
...
**Diagram sources**
- [pipeline.dot](src/pipeline/lexicon/pipeline.dot#L1-L64)
...
- [01-harvest.ts](src/pipeline/lexicon/01-harvest.ts#L1-L49)
...
- [06-ingest.ts](src/pipeline/lexicon/06-ingest.ts#L1-L142)
- [07-classify-relevance.ts](src/pipeline/lexicon/07-classify-relevance.ts#L1-L253)
- [dashboard.ts](src/pipeline/lexicon/dashboard.ts#L1-L316)
...
**Diagram sources**
- [dashboard.ts](src/pipeline/lexicon/dashboard.ts#L242-L271)
- [01-harvest.ts](src/pipeline/lexicon/01-harvest.ts#L8-L48)
- [02-refine.ts](src/pipeline/lexicon/02-refine.ts#L89-L152)
- [03-enrich.ts](src/pipeline/lexicon/03-enrich.ts#L47-L131)
- [05-survey-edges.ts](src/pipeline/lexicon/05-survey-edges.ts#L45-L102)
- [06-ingest.ts](src/pipeline/lexicon/06-ingest.ts#L13-L141)
...
**Diagram sources**
- [LexiconHarvester.ts](src/core/LexiconHarvester.ts#L35-L174)
...
**Diagram sources**
- [07-classify-relevance.ts](src/pipeline/lexicon/07-classify-relevance.ts#L23-L173)
...
**Section sources**
- [02-refine.ts](src/pipeline/lexicon/02-refine.ts#L110-L138)
- [03-enrich.ts](src/pipeline/lexicon/03-enrich.ts#L90-L119)
- [05-survey-edges.ts](src/pipeline/lexicon/05-survey-edges.ts#L62-L89)
- [06-ingest.ts](src/pipeline/lexicon/06-ingest.ts#L97-L117)
- [07-classify-relevance.ts](src/pipeline/lexicon/07-classify-relevance.ts#L106-L125)
...
- [03-enrich.ts](src/pipeline/lexicon/03-enrich.ts#L113-L114)
- [05-survey-edges.ts](src/pipeline/lexicon/05-survey-edges.ts#L75-L81)
- [07-classify-relevance.ts](src/pipeline/lexicon/07-classify-relevance.ts#L12-L21)
...
**Section sources**
- [03-enrich.ts](src/pipeline/lexicon/03-enrich.ts#L51-L81)
- [06-ingest.ts](src/pipeline/lexicon/06-ingest.ts#L22-L58)
...
- Lexicon configuration (paths and outputs):
  ...
  - Example references:
    - [01-harvest.ts](src/pipeline/lexicon/01-harvest.ts#L11-L15)
    - [02-refine.ts](src/pipeline/lexicon/02-refine.ts#L8-L11)
...
- Public lexicon preview:
  - Example entries in public dataset:
    - [public/data/lexicon.jsonl](public/data/lexicon.jsonl#L945-L947)
