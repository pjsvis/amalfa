        ...
        if (item.type === "text") {
          ...
          try {
            ...
            if ("entities" in parsed) {
              console.log(`   ✅ entities field: ${Array.isArray(parsed.entities) ? "array" : typeof parsed.entities}`);
            } else {
              console.log(`   ❌ entities field missing`);
            }

            if ("relationships" in parsed) {
              console.log(`   ✅ relationships field: ${Array.isArray(parsed.relationships) ? "array" : typeof parsed.relationships}`);
            } else {
