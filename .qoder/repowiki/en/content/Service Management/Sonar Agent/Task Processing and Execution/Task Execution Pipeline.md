...
- Task logic and orchestration: [sonar-logic.ts](src/daemon/sonar-logic.ts)
- Strategies for routing and LLM tasks: [sonar-strategies.ts](src/daemon/sonar-strategies.ts)
...
- Type definitions: [sonar-types.ts](src/daemon/sonar-types.ts)
- Core graph engine: [GraphEngine.ts](src/core/GraphEngine.ts)
- Graph gardening utilities: [GraphGardener.ts](src/core/GraphGardener.ts)
- Vector search engine: [VectorEngine.ts](src/core/VectorEngine.ts)
- ResonanceDB graph storage: [db.ts](src/resonance/db.ts)
- Notifications and logging utilities: [Notifications.ts](src/utils/Notifications.ts), [Logger.ts](src/utils/Logger.ts)
...
- [Logger.ts](src/utils/Logger.ts#L15-L22)
...
**Diagram sources**
- [sonar-strategies.ts](src/daemon/sonar-strategies.ts#L10-L28)
- [sonar-inference.ts](src/daemon/sonar-inference.ts#L19-L85)
...
- [GraphEngine.ts](src/core/GraphEngine.ts#L50-L100)
- [db.ts](src/resonance/db.ts#L194-L239)
- [VectorEngine.ts](src/core/VectorEngine.ts#L159-L241)
...
**Diagram sources**
- [sonar-agent.ts](src/daemon/sonar-agent.ts#L150-L178)
- [sonar-logic.ts](src/daemon/sonar-logic.ts#L323-L364)
- [Notifications.ts](src/utils/Notifications.ts#L8-L30)
...
**Section sources**
- [sonar-agent.ts](src/daemon/sonar-agent.ts#L107-L115)
...
- [sonar-logic.ts](src/daemon/sonar-logic.ts#L1-L16)
