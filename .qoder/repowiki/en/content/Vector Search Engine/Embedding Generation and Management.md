...
- [test-embeddings.ts](scripts/test-embeddings.ts)
- [compare-embedding-models.ts](scripts/compare-embedding-models.ts)
- [debug-embedding-quality.ts](scripts/lab/debug-embedding-quality.ts)
- [config-defaults.ts](src/config/defaults.ts)
- [amalfa.settings.json](amalfa.settings.json)
- [local_cache fast-bge-small-en-v1.5 config.json](local_cache/fast-bge-small-en-v1.5/config.json)
</cite>
...
- [test-embeddings.ts](scripts/test-embeddings.ts#L1-L222)
- [compare-embedding-models.ts](scripts/compare-embedding-models.ts#L1-L189)
- [debug-embedding-quality.ts](scripts/lab/debug-embedding-quality.ts#L1-L73)
...
- [VectorEngine.ts](src/core/VectorEngine.ts#L76-L139)
- [db.ts](src/resonance/db.ts#L467-L487)
- [config-defaults.ts](src/config/defaults.ts#L16-L59)
- [amalfa.settings.json](amalfa.settings.json#L11-L14)
...
- [db.ts](src/resonance/db.ts#L94-L134)
...
**Section sources**
- [embedder.ts](src/resonance/services/embedder.ts#L19-L124)
...
**Section sources**
- [VectorEngine.ts](src/core/VectorEngine.ts#L76-L139)
- [VectorEngine.ts](src/core/VectorEngine.ts#L144-L240)
...
- [embedder.ts](src/resonance/services/embedder.ts#L97-L123)
...
**Diagram sources**
- [embedder.ts](src/resonance/services/embedder.ts#L45-L57)

**Section sources**
- [embedder.ts](src/resonance/services/embedder.ts#L27-L57)
- [compare-embedding-models.ts](scripts/compare-embedding-models.ts#L163-L181)
- [local_cache fast-bge-small-en-v1.5 config.json](local_cache/fast-bge-small-en-v1.5/config.json#L10)
...
**Section sources**
- [embedder.ts](src/resonance/services/embedder.ts#L68-L77)
- [vector-daemon.ts](src/resonance/services/vector-daemon.ts#L40-L47)
- [config-defaults.ts](src/config/defaults.ts#L16-L29)
...
**Section sources**
- [vector-daemon.ts](src/resonance/services/vector-daemon.ts#L72-L75)
- [compare-embedding-models.ts](scripts/compare-embedding-models.ts#L141-L181)
...
- [embedder.ts](src/resonance/services/embedder.ts#L80-L124)
- [vector-daemon.ts](src/resonance/services/vector-daemon.ts#L162-L219)
- [test-embeddings.ts](scripts/test-embeddings.ts#L42-L222)
- [compare-embedding-models.ts](scripts/compare-embedding-models.ts#L45-L189)
- [debug-embedding-quality.ts](scripts/lab/debug-embedding-quality.ts#L1-L73)
