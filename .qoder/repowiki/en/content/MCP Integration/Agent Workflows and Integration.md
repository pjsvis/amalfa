...
- [AGENT-METADATA-PATTERNS.md](docs/AGENT-METADATA-PATTERNS.md)
...
- [src/utils/Scratchpad.ts](src/utils/Scratchpad.ts#L59-L190)
- [src/utils/Historian.ts](src/utils/Historian.ts#L31-L126)
- [src/daemon/sonar-agent.ts](src/daemon/sonar-agent.ts#L60-L116)
- [src/daemon/sonar-server.ts](src/daemon/sonar-server.ts#L24-L133)
- [src/daemon/sonar-logic.ts](src/daemon/sonar-logic.ts#L19-L685)
- [src/daemon/sonar-inference.ts](src/daemon/sonar-inference.ts#L19-L120)
- [src/daemon/sonar-strategies.ts](src/daemon/sonar-strategies.ts#L10-L187)
- [src/utils/sonar-client.ts](src/utils/sonar-client.ts#L54-L270)
- [src/utils/reranker-client.ts](src/utils/reranker-client.ts#L137-L209)
...
- [src/daemon/sonar-server.ts](src/daemon/sonar-server.ts#L24-L133)
- [src/core/GraphEngine.ts](src/core/GraphEngine.ts#L39-L100)
- [src/core/VectorEngine.ts](src/core/VectorEngine.ts#L76-L110)
- [src/utils/Scratchpad.ts](src/utils/Scratchpad.ts#L59-L190)
- [src/utils/Historian.ts](src/utils/Historian.ts#L31-L126)
- [src/utils/ToolRegistry.ts](src/utils/ToolRegistry.ts#L8-L30)
...
- [src/daemon/sonar-server.ts](src/daemon/sonar-server.ts#L93-L130)
...
- [src/utils/reranker-client.ts](src/utils/reranker-client.ts#L137-L209)
- [src/utils/sonar-client.ts](src/utils/sonar-client.ts#L118-L268)
- [src/utils/Scratchpad.ts](src/utils/Scratchpad.ts#L75-L92)
...
**Diagram sources**
- [src/daemon/sonar-agent.ts](src/daemon/sonar-agent.ts#L138-L217)
- [src/daemon/sonar-server.ts](src/daemon/sonar-server.ts#L24-L133)
- [src/daemon/sonar-logic.ts](src/daemon/sonar-logic.ts#L470-L664)
- [src/daemon/sonar-strategies.ts](src/daemon/sonar-strategies.ts#L34-L187)
- [src/daemon/sonar-inference.ts](src/daemon/sonar-inference.ts#L19-L120)

**Section sources**
- [src/daemon/sonar-agent.ts](src/daemon/sonar-agent.ts#L60-L116)
- [src/daemon/sonar-server.ts](src/daemon/sonar-server.ts#L24-L133)
- [src/daemon/sonar-logic.ts](src/daemon/sonar-logic.ts#L323-L364)
- [src/daemon/sonar-logic.ts](src/daemon/sonar-logic.ts#L470-L664)
- [src/daemon/sonar-strategies.ts](src/daemon/sonar-strategies.ts#L10-L187)
- [src/daemon/sonar-inference.ts](src/daemon/sonar-inference.ts#L19-L120)
...
**Section sources**
- [src/core/GraphEngine.ts](src/core/GraphEngine.ts#L50-L100)
- [src/core/VectorEngine.ts](src/core/VectorEngine.ts#L155-L242)
...
**Section sources**
- [docs/AGENT_PROTOCOLS.md](docs/AGENT_PROTOCOLS.md#L1-L30)
- [AGENTS.md](AGENTS.md#L1-L38)
- [docs/AGENT-METADATA-PATTERNS.md](docs/AGENT-METADATA-PATTERNS.md#L40-L122)
...
**Section sources**
- [src/utils/sonar-client.ts](src/utils/sonar-client.ts#L118-L268)
- [src/utils/reranker-client.ts](src/utils/reranker-client.ts#L20-L80)
- [src/mcp/index.ts](src/mcp/index.ts#L727-L743)
- [src/utils/Historian.ts](src/utils/Historian.ts#L66-L126)
- [src/utils/Scratchpad.ts](src/utils/Scratchpad.ts#L272-L349)
...
**Section sources**
- [docs/AGENT_PROTOCOLS.md](docs/AGENT_PROTOCOLS.md#L11-L28)
- [src/daemon/sonar-agent.ts](src/daemon/sonar-agent.ts#L138-L179)
- [src/utils/reranker-client.ts](src/utils/reranker-client.ts#L137-L209)
- [src/utils/Scratchpad.ts](src/utils/Scratchpad.ts#L63-L75)
...
- [src/utils/ToolRegistry.ts](src/utils/ToolRegistry.ts#L8-L30)
- [src/daemon/sonar-logic.ts](src/daemon/sonar-logic.ts#L323-L364)
- [src/daemon/sonar-strategies.ts](src/daemon/sonar-strategies.ts#L10-L28)
- [src/daemon/sonar-inference.ts](src/daemon/sonar-inference.ts#L19-L120)