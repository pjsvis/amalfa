...
const testFiles = [
	...
	{
		old: "docs/2026-01-07-CODEBASE-AUDIT.md",
		new: "docs/audits/2026-01-07-CODEBASE-AUDIT.md",
	},
...
for (const test of testFiles) {
	...
	if (newExists) {
		...
		console.log(
			`⚠️  Neither old nor new path found for: ${test.old.split("/").pop()}`,
		);
	}
}
...
console.log(
	`💾 Database size: ${(db.getStats().db_size_bytes / 1024 / 1024).toFixed(2)} MB`,
);
