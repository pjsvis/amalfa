...
- [definition-of-done-playbook.md](playbooks/definition-of-done-playbook.md)
- [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md)
...
- [test-ingestion-performance.ts](scripts/lab/test-ingestion-performance.ts)
- [test-embeddings.ts](scripts/verify/test-embeddings.ts)
- [test-hardening.ts](scripts/verify/test-hardening.ts)
- [test-queries.ts](scripts/verify/test-queries.ts)
- [verify_integrity.ts](scripts/verify/verify_integrity.ts)
- [verify_db_content.ts](scripts/verify/verify_db_content.ts)
- [verify_rescue.ts](scripts/verify/verify_rescue.ts)
- [verify_sync.ts](scripts/verify/verify_sync.ts)
- [verify_unification.ts](scripts/verify/verify_unification.ts)
- [verify_graph_integrity.ts](scripts/verify/verify_graph_integrity.ts)
- [verify_pipeline_stages.ts](scripts/verify/verify_pipeline_stages.ts)
- [verify_root_cause.ts](scripts/verify/verify_root_ause.ts)
- [round-trip-test.ts](scripts/lab/round-trip-test.ts)
- [consistency-analysis.ts](scripts/lab/consistency-analysis.ts)
- [audit_vectors.ts](scripts/lab/audit_vectors.ts)
- [test-id-generation.ts](scripts/lab/test-id-generation.ts)
- [test-squasher.ts](scripts/lab/test-squasher.ts)
- [test-vector-engine.ts](scripts/verify/test-vector-engine.ts)
- [test-mcp-query.ts](scripts/verify/test-mcp-query.ts)
- [test-mcp-concurrent.ts](scripts/verify/test-mcp-concurrent.ts)
- [test-mcp-lifecycle.ts](scripts/verify/test-mcp-lifecycle.ts)
- [test-phi3-agent.ts](scripts/verify/test-phi3-agent.ts)
- [test-provider-comparison.ts](scripts/test-provider-comparison.ts)
...
- [test-config-search.ts](scripts/test-config-search.ts)
- [test-notification.ts](scripts/test-notification.ts)
- [test-sidecar-generation.ts](scripts/test-sidecar-generation.ts)
- [test-sonar-capabilities.test.ts](scripts/verify/verify-sonar-capabilities.test.ts)
...
- [sonar-server.test.ts](tests/sonar-server.test.ts)
...
- [mcp-server-settings.json](tests/mcp-server-settings.json)
- [test-providers.ts](tests/ollama/test-providers.ts)
- [TERRAIN_MAP.md](tests/ollama/TERRAIN_MAP.md)
- [COMPARISON.md](tests/langextract-comparison/COMPARISON.md)
- [SUMMARY.md](tests/langextract-comparison/SUMMARY.md)
- [REPORT.md](tests/langextract-comparison/REPORT.md)
- [TEST_RESULTS.md](tests/langextract-comparison/TEST_RESULTS.md)
- [RESULTS.md](tests/langextract-results/RESULTS.md)
- [test-models.ts](tests/langextract-comparison/test-models.ts)
- [health-check.ts](tests/langextract-comparison/health-check.ts)
- [results.jsonl](tests/langextract-results/results.jsonl)
- [test-ollama-cloud.ts](tests/substrate/test-ollama-cloud.ts)
- [ping-substrates.ts](tests/substrate/ping-substrates.ts)
- [debug-substrate.ts](tests/substrate/debug-substrate.ts)
- [test-parsing.ts](tests/substrate/test-parsing.ts)
- [test-vectors.jsonl](.amalfa/test-vectors.jsonl)
- [cross-domain-edges.jsonl](.amalfa/cross-domain-edges.jsonl)
- [golden-lexicon.jsonl](.amalfa/golden-lexicon.jsonl)
- [final-nodes.jsonl](.amalfa/final-nodes.jsonl)
- [pipeline-history.jsonl](.amalfa/pipeline-history.jsonl)
- [runs.jsonl](.amalfa/runs.jsonl)
- [.amalfa-test-env/resonance.db](.amalfa-test-env/resonance.db)
- [resonance.db](.amalfa/resonance.db)
- [resonance.db-shm](.amalfa/resonance.db-shm)
- [resonance.db-wal](.amalfa/resonance.db-wal)
</cite>
...
**Diagram sources**
- [definition-of-done-playbook.md](playbooks/definition-of-done-playbook.md#L15-L40)
- [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md#L186-L256)
- [e2e-web-testing-playbook.md](playbooks/e2e-web-testing-playbook.md#L53-L104)
- [dashboard-e2e.test.ts](tests/e2e/dashboard-e2e.test.ts#L62-L178)
- [incremental-ingestion.test.ts](tests/pipeline/incremental-ingestion.test.ts#L6-L28)
- [DatabaseFactory.test.ts](tests/DatabaseFactory.test.ts#L6-L36)
- [harvester.test.ts](tests/harvester.test.ts#L4-L22)
- [weaver.test.ts](tests/weaver.test.ts#L34-L60)
- [simple_search_test.ts](scripts/verify/simple_search_test.ts)
- [test-ingestion-performance.ts](scripts/lab/test-ingestion-performance.ts)
- [test-embeddings.ts](scripts/verify/test-embeddings.ts)
- [verify_integrity.ts](scripts/verify/verify_integrity.ts)
...
- [benchmark-reranking-comparison.ts](scripts/benchmarks/benchmark-reranking-comparison.ts#L160-L220)
- [compare-reranking-results.ts](scripts/benchmarks/compare-reranking-results.ts#L19-L77)
...
**Diagram sources**
- [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md#L61-L115)
- [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md#L119-L160)
- [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md#L162-L185)
- [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md#L186-L256)
...
**Diagram sources**
- [definition-of-done-playbook.md](playbooks/definition-of-done-playbook.md#L15-L40)
- [definition-of-done-playbook.md](playbooks/definition-of-done-playbook.md#L48-L54)
- [definition-of-done-playbook.md](playbooks/definition-of-done-playbook.md#L56-L89)
...
- Ingestion: [incremental-ingestion.test.ts](tests/pipeline/incremental-ingestion.test.ts#L6-L28)
- Search: [simple_search_test.ts](scripts/verify/simple_search_test.ts), [benchmark-search-baseline.ts](scripts/benchmarks/benchmark-search-baseline.ts#L63-L113)
- Services: [test-mcp-query.ts](scripts/verify/test-mcp-query.ts), [test-mcp-concurrent.ts](scripts/verify/test-mcp-concurrent.ts), [test-mcp-lifecycle.ts](scripts/verify/test-mcp-lifecycle.ts)
...
- [verify_graph_integrity.ts](scripts/verify/verify_graph_integrity.ts)
- [verify_pipeline_stages.ts](scripts/verify/verify_pipeline_stages.ts)
- [verify_root_ause.ts](scripts/verify/verify_root_ause.ts)
- [round-trip-test.ts](scripts/lab/round-trip-test.ts)
- [consistency-analysis.ts](scripts/lab/consistency-analysis.ts)
- [audit_vectors.ts](scripts/lab/audit_vectors.ts)
- [test-id-generation.ts](scripts/lab/test-id-generation.ts)
...
**Section sources**
- [e2e-web-testing-playbook.md](playbooks/e2e-web-testing-playbook.md#L315-L326)
- [dashboard-e2e.test.ts](tests/e2e/dashboard-e2e.test.ts#L22-L50)
- [DatabaseFactory.test.ts](tests/DatabaseFactory.test.ts#L9-L35)
- [incremental-ingestion.test.ts](tests/pipeline/incremental-ingestion.test.ts#L6-L28)
...
- Example test references:
  - Ingestion: [incremental-ingestion.test.ts](tests/pipeline/incremental-ingestion.test.ts#L6-L28)
  - Database Factory: [DatabaseFactory.test.ts](tests/DatabaseFactory.test.ts#L6-L36)
  - Harvester: [harvester.test.ts](tests/harvester.test.ts#L4-L22)
  - Weaver: [weaver.test.ts](tests/weaver.test.ts#L34-L60)
  - E2E Dashboard: [dashboard-e2e.test.ts](tests/e2e/dashboard-e2e.test.ts#L62-L178)
  - Search Baseline: [benchmark-search-baseline.ts](scripts/benchmarks/benchmark-search-baseline.ts#L63-L113)
  - Reranking Comparison: [benchmark-reranking-comparison.ts](scripts/benchmarks/benchmark-reranking-comparison.ts#L160-L220)
  - Consistency Audit: [consistency-audit-playbook.md](playbooks/consistency-audit-playbook.md#L186-L256)
  - Definition of Done: [definition-of-done-playbook.md](playbooks/definition-of-done-playbook.md#L15-L40)
